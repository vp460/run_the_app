...
def create_order():
    ...
    painting_id = form_data["painting_id"]
    painting_title = form_data["painting_title"]
    painting_price = form_data["painting_price"]
    ...
    try:
        params = {
            ...
            "painting_id": int(painting_id),
            "painting_title": painting_title,
            "painting_price": float(painting_price)
        }
        #order = Order(params)
        #order.save()
        # alternatively:
